...
ggsave("results/Stats_Overall_Trend_of_All_the_Metal_Resistant_Genes.png", plot = metal_data, width = 10, height = 12, dpi = 300)
ggsave("results/Stats_Overall_Trend_of_All_the_Metal_Resistant_Genes.pdf", plot = metal_data, width = 10, height = 12)
